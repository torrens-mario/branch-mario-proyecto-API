...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    } else if (hash === 'vulnerabilidades') {
    document.querySelector('[data-view="vulnerabilidades"]').click();
    } else {
        await loadAssets();
    }
});
...
// Modificar el event listener de navegación para incluir vulnerabilidades
navItems.forEach(item => {
    ...
    item.addEventListener('click', async (e) => {
        ...
        if (viewName === 'activos') {
            ...
            // Esta función viene de vulnerabilities.js
...
// Actualizar la inicialización para incluir vulnerabilidades
document.addEventListener('DOMContentLoaded', async () => {
    console.log('Dashboard cargado con módulo de vulnerabilidades');

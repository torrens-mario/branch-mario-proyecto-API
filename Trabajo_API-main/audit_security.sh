...
RESULT=$(docker exec soil-sensor-001 python3 -c "import socket; s = socket.socket(); s.settimeout(2); print('ABIERTA' if s.connect_ex(('172.30.0.20', 8000)) == 0 else 'AISLADA')" 2>/dev/null)

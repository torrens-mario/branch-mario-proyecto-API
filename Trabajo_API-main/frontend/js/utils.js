...
/**
 * Parsea respuesta JSON de forma segura
 */
async function safeJsonParse(response) {
    ...
    try {
        ...
        // Si la respuesta es HTML, probablemente es una página de error
        if (text.includes('<!DOCTYPE') || text.includes('<html')) {
            throw new Error('El servidor devolvió HTML en lugar de JSON. Verifique que la API esté funcionando.');
        }
...
async function getData(url) {
    try {
        ...
        console.log('GET Request:', API_BASE + url);

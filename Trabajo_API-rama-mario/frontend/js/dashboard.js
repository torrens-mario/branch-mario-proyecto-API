...
Estado: ${formatStatus(asset.status)}
Nivel de Riesgo: ${formatRisk(asset.risk_level)}

IP: ${asset.ip_address || 'N/A'}
Hostname: ${asset.hostname || 'N/A'}
Sistema Operativo: ${asset.os_version || 'N/A'}
Ubicación: ${asset.location || 'N/A'}

Descripción: ${asset.description || 'N/A'}

Creado: ${formatDate(asset.created_at)}
Actualizado: ${formatDate(asset.updated_at)}
    `;
    alert(details);
}
// Continuación del dashboard.js...
